...
public class ForgotPasswordView {
    ...
    public Scene createScene() {
        ...
        sendOtpButton.setOnAction(event -> {
            ...
            if (resetId == -1) {
                ...
                showError(
                        messageLabel,
                        "The User ID and email did not match, or the OTP email could not be sent."
                );
    ...
    private void playShakeAnimation(
        ...
        second.setOnFinished(event ->
                third.play()
        );

        third.setOnFinished(event ->
                fourth.play()
        );
